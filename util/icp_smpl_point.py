...
def icp_mesh_and_point(mesh, 
    ...
    return reg_mesh, deltaT.numpy().squeeze()
...
if __name__ == '__main__':
    ...
    mesh = o3d.io.read_triangle_mesh('C:\\Users\\DAI\\Desktop\\temp\\2_0319.ply')
    pointcoud = o3d.io.read_point_cloud('C:\\Users\\DAI\\Desktop\\temp\\2_0319.pcd')
    trajs = np.loadtxt('C:\\Users\\DAI\\Desktop\\temp\\synced_lidar_trajectory.txt')

    _, deltaT = icp_mesh_and_point(mesh, pointcoud, trajs[trajs[:,0].tolist().index(319)][1:8], max_correspondence_distance =0.1,)
